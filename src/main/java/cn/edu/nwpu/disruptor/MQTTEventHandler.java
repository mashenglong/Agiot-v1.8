...
public class MQTTEventHandler implements WorkHandler<QueueEvent>, EventHandler<QueueEvent> {
    ...
    private final Long maxWait = 10000000L;
    private final MqttConnectionPool mPool = new MqttConnectionPool(maxActive, maxWait);
...
//        Long maxWait = 10000000L;
        ...
        log.info("MQTTEventHandler MQTT:" + queueEvent.getSensorData().toString());
    }
}
